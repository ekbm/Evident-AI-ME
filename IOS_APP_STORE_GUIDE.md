...
### App Icons
Your app icon is saved at `attached_assets/evident-app-icon.png`. Use this to generate all required sizes:

1. Go to [appicon.co](https://appicon.co/)
2. Upload `attached_assets/evident-app-icon.png`
3. Download the generated icon set
4. Copy all icons to `ios/App/App/Assets.xcassets/AppIcon.appiconset/`

Required sizes: 20x20, 29x29, 40x40, 60x60, 76x76, 83.5x83.5, 1024x1024 (various @2x, @3x)
